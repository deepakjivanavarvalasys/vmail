...
$(function (){
        ...
        "ajax": {
            ...
            data: {
                ...
                start_date: function (){
                    ...
                    localStorage.setItem("start_date", JSON.stringify(obj));
                ...
                end_date: function (){
                    ...
                    localStorage.setItem("end_date", JSON.stringify(obj));
                    return JSON.stringify(obj);
                }
            },
        ...
        "columns": [
            {
                ...
                let newcampaign='';
                    ...
                    if(row.firstcampaignopen == 0)
                    {
                        newcampaign='<i class="feather icon-eye-off mr-0" style="color:red;"></i>';
                    }else
                    {
                        newcampaign='<i class="feather icon-eye mr-0" style="color:green;"></i>';
                    }
                    return newcampaign+' |  '+row.campaign.campaign_id;
                }
            },
            {
                orderable: false,
    ...
    $('#button-campaign-assign').on('click', function(e) {
        ...
        if($("#form-campaign-assign").valid()) {
            ...
            $("#campaign_assign_rasme_id").val($("#campaign_list_"+campaign_id).data('caratl-id'));
            $("#modal-campaign-assign").find('.modal-body').html(html);
