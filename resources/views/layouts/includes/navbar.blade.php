        ...
        <ul class="navbar-list">
           <li>
              <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center bg-primary rounded">
                 <img src="{{ asset('assets/images/user/default-user.png') }}" class="img-fluid rounded mr-3" alt="user">
                 <div class="caption">
                    <h6 class="mb-0 line-height text-white">{{ ucFirst(auth()->user()->name) }}</h6>
              ...
              <div class="iq-sub-dropdown iq-user-dropdown">
                 <div class="iq-card shadow-none m-0">
                    <div class="iq-card-body p-0 ">
                       <div class="bg-primary p-3">
                          <h5 class="mb-0 text-white line-height">{{ ucFirst(auth()->user()->name) }}</h5>
                       ...
                       <form method="POST" action="{{ route('logout') }}">
                        @csrf
                          <a href="{{route('logout')}}" onclick="event.preventDefault(); this.closest('form').submit();" class="iq-sub-card iq-bg-primary-hover">
                            <div class="media align-items-center">
                              <div class="rounded iq-card-icon iq-bg-primary">
                              ...
                              <div class="media-body ml-3">
                                  ...
                                  <p class="mb-0 font-size-12">sign out of your account.</p>
                              </div>
                            </div>
                        </a>
                      </form>
                       ...
                       <div class="d-inline-block w-100 text-center p-3">
                          <a class="btn btn-primary dark-btn-primary" href="{{ route('dashboard') }}" role="button">Dashboard<i class="ri-home-4-line ml-2"></i></a> 
                       </div>
                    </div>
                 </div>
              </div>
